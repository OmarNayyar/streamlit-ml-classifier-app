"""Original guided-project baseline preserved for comparison.

Keep this file as the tutorial-era reference implementation and use `app.py`
for the upgraded portfolio version.
"""
